...
A Vite + React app implementing the NeuroSense clinical dashboard:
...
| --- | --- | --- |
| `maya@neurosense.app` | TW-0042 Maya Lindqvist | NFL trending elevated, Lisbon heat advisory, Ocrevus 6-monthly |
| `jonas@neurosense.app` | TW-0117 Jonas Weber | All markers stable, Berlin, Kesimpta monthly |
...
| Patient mock configuration | Per-patient thresholds and dashboard data |
